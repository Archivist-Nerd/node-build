...
'use strict';
/**
 * @api:name    requires  required node modules
 * @api:group   requires
 *
 * @api:const  {Require} fs       node system module
 * @api:const  {Require} path     node system module
 */
const fs   = require('fs')
    , path = require('path')
    ;
/**
 * @api:removeComments    remove multi line comments. (Keeps first comment)
 * @api:group   functions
 *
 * @api:param  {String}   javascript source text
 */
...
/**
 * @api:name    build  processes a buldfile
 * @api:group   functions
 *
 * @api:param  {String}       path and filename of build file
 */
...
/**
 * @api:name    module.exports exports object { build: build }
 * @api:group   init
 */
module.exports = {
  build,
